...
def download_stopwords():
    ...
    stopwords_dir = f"{project_dir}/data/3 - Network Generation/stopwords"
...
def set_export_folder(folder_name):
    ...
    print(f"Export directory set to {project_dir}/data/3 - Network Generation/{export_folder_name}.")



def import_nodelist():
    nodelist_dir = f"{project_dir}/data/3 - Network Generation/{export_folder_name}"
...
def save_nodelist(nodelist_dict):
    new_nodelist_dir = f"{project_dir}/data/3 - Network Generation/{export_folder_name}"
...
def save_edgelist(df):
    directory = f"{project_dir}/data/3 - Network Generation/{export_folder_name}"
